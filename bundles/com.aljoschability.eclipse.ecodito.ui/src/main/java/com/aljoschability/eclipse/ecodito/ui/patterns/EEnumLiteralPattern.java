...
public class EEnumLiteralPattern extends CorePattern {
	public EEnumLiteralPattern(IPatternConfiguration patternConfiguration) {
		super();
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		EEnumLiteral bo = (EEnumLiteral) context.getNewObject();
		link(pe, bo);
	...
	protected EObject createElement(ICreateContext context) {
		EEnum eEnum = (EEnum) getBO(context.getTargetContainer());

		EEnumLiteral element = EcoreFactory.eINSTANCE.createEEnumLiteral();
